...
function Card({ titolo, contenuto, immagine }) {
    return (
        <div
            className={`${style.card} shadow-lg shadow-stone-500 bg-white rounded-xl overflow-hidden max-w-[60vw] sm:max-w-[36vw] lg:max-w-[325px] hover:scale-110 hover:rotate-6 hover:shadow-xl hover:shadow-zinc-700 transition-all`}
        >
            <div className="h-3/5">
                <img
