...
function Card({ titolo, contenuto, immagine }) {
    return (
        <div
            className={`${style.card} shadow-lg shadow-stone-500 bg-white rounded-xl mx-2 my-4 w-full sm:w-[calc((100%-32px)/2)] lg:w-[calc((100%-48px)/3)] overflow-hidden hover:scale-110 hover:rotate-6 hover:shadow-xl hover:shadow-zinc-700 transition-all`}
        >
            <div className="h-3/5">
                <img
